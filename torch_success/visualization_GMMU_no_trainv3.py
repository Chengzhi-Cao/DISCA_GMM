...
# v3 重新写torch版本的statistical_fitting_tf_split_merge,看看uniform是怎么回事
...
#stored path
parser.add_argument("--saving_path", type=str, default='/data/zfr888/EMD_4603/Results_torch1009_success')
...
for model_name in model_names:
    ...
    labels_temp_proba, labels_temp, K, same_K, features_pca, gmm = statistical_fitting_torch_split_merge(features = np.squeeze(features), \
            ...
            K = None, reg_covar = reg_covar, it = 0,\
