...
#stored path
parser.add_argument("--saving_path", type=str, default='/data/zfr888/EMD_4603/Results_torch1016v5_scan_num1_10000_subtomo8000_vector32_CrossEntropyLoss')
parser.add_argument("--algorithm_name", type=str, default='gmm')
# parser.add_argument("--algorithm_name", type=str, default='gmmu')

parser.add_argument("--sub_epoch", type=int,default=40)
