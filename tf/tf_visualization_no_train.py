...
#stored path
parser.add_argument("--saving_path", type=str, default='/data/zfr888/EMD_4603/Results_tf0919v3')
...
if args.GMMU_visual == True:
    ...
    for model_name in model_names:
        ...
        if not os.path.isdir(figure_path):
            os.makedirs(figure_path)
        yopo = YOPO_feature(image_size)   ### create a new model
        features = yopo.predict([x_train, x_train, x_train])[0]
